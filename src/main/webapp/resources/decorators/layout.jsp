...
<s:url var="urlRutaContextoTema"
	...
	includeContext="true" />
<sj:head debug="true" jqueryui="true" loadAtOnce="true"
	jquerytheme="custom-eld-1.0" locale="es"
...
<link rel="stylesheet"
	...
	type="text/css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/components/jQuery.Gantt/css/style.css"
	type="text/css" />
<jsp:text>
	<![CDATA[
				...
				<script type="text/javascript" src="${pageContext.request.contextPath}/struts/js/struts2/jquery.ui.struts2.min.js?s2j=4.0.2&s2j=4.0.2"></script>
		        ...
		        <script src="${pageContext.request.contextPath}/resources/components/jQuery.Gantt/js/jquery.fn.gantt.min.js" type="text/javascript"></script>
