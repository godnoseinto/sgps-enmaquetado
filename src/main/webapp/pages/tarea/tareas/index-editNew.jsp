	...
	<div class="row content">
		...
		<fieldset class="form form-horizontal form-medium">
			...
			<div class="form-group col-sm-12">
					...
					<div class="col-xs-12 col-sm-10 col-md-10">
						<s:textfield cssClass="form-control campo"
							cssClassError="input-error" name="model.nombreT" id="txTarea"  value="Tarea Dos"/>
			...
			<div class="form-group col-sm-4">
					...
					<div class="col-xs-12 col-sm-8 col-md-8">
						<s:select id="slcListEstadoTarea" list="#{'1':'En progreso','2':'Pausado','3':'Cancelado','4','Finalizado'}"
							cssClass="form-control" cssErrorClass="field-error" />
						<s:fielderror fieldName="model.idTipo" cssClass="error"
							theme="%{#theme}" />
					</div>
